<?php
    ...
    session_start();
    $v = new View;
    $v->SectionHeader('แบบทดสอบความรู้เรื่อง Subject verb agreement เลเวล 2');
?>
...
<body>
    <div class="grid-container">
      ...
      <div class="item3"><a href="sv_level2.php"><img src="../picture/cross.png" style="width:50px;margin-right:3em;"></a></div>  
    </div>
    <div class="header">
        <h3>แบบทดสอบความรู้เรื่อง Subject verb agreement เลเวล 2</h3>
    </div>
    <div class="container">
    ...
    <?php
        ...
        unset($v);
    ?>
    <script src="../script/SV_Level2.js"></script>
</body>
</html>