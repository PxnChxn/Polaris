<?php
  ...
  session_start();
  $v = new View;
  $v->SectionHeader('SV Agreement lev.2');
?>
<style>
  * {
...
?>
  <div class="grid-container">
      <div class="item1"><a href="sv_quiz_level2.php" class="button" style="font-size:18px;">QUIZ</a></div>
  ...
  <video autoplay muted loop id="vdo"> <source src="../picture/Bgvdo.mp4" type="video/mp4"></video>
	<div class="slideshow-container">
        <div class="mySlides fade">
          ...
          <img src="../picture/SV.Agreement/level2/9.png" style="width:100%">
        </div>
        <div class="mySlides fade">
          <div class="numbertext">2 / 4</div>
          <img src="../picture/SV.Agreement/level2/10.png" style="width:100%">
        </div>
        <div class="mySlides fade">
          <div class="numbertext">3 / 4</div>
          <img src="../picture/SV.Agreement/level2/11.png" style="width:100%">
        </div>
        <div class="mySlides fade">
          <div class="numbertext">4 / 4</div>
          <img src="../picture/SV.Agreement/level2/12.png" style="width:100%">
        </div>
